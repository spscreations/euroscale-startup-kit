...
type CreateDatabaseRequest struct {
	...
	ParentDatabaseId string `protobuf:"bytes,5,opt,name=parent_database_id,json=parentDatabaseId,proto3" json:"parent_database_id,omitempty"`
...
func (x *CreateDatabaseRequest) GetParentDatabaseId() string {
	if x != nil {
		return x.ParentDatabaseId
	}
	return ""
}
